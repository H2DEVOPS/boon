...
describe("projectDashboardState", () => {
  ...
  it("event replay produces identical state", () => {
    ...
    const events = [
      { type: "PartSnoozed" as const, partId: "B", notificationDate: "2025-02-25", timestamp: TS },
    ];
  ...
  it("snoozed deterministic expiry", () => {
    ...
    const events = [
      { type: "PartSnoozed" as const, partId: "S", notificationDate: "2025-02-20", timestamp: TS },
    ];
